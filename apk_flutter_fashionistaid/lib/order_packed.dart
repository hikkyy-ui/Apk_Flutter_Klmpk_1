...
import 'package:apk_flutter_fashionistaid/other_1.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: OrderPackedPage(),
    );
  }
}

class OrderPackedPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            children: [
              ...
              OutlinedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => OrderPackedPage()),
                  );
                },
                child: Text(
                  'Chat Penjual',
